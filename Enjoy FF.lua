...
if menu1[1] == true then AX1() end

if menu1[2] == true then AX2() end

if menu1[3] == true then AX3() end
...
gg.searchNumber("7Fr;45r;4Cr;46r;01r;01r;01r;00r::8", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0x4000000, 0x6E1100)
gg.getResultsCount()
gg.getResults(8)
