...
-------------------------------------------------------------------------
Name =  'acengerz(V1).lua' -- Type Name For Start Script . If Someone Will Rename It , Then Script Won't Run
-------------------------------------------------------------------------
...
while(nil)do;local i={}if(i.i)then;i.i=(i.i(i))end;end
  ...
  function FDKTT()
while(nil)do;local i={}if(i.i)then;i.i=(i.i(i))end;end  gg.clearResults()
  gg.setRanges(gg.REGION_CODE_APP | gg.REGION_C_DATA)
  name("libil2cpp.so")
  myoffset = 29546608
  original("7F 45 4C 46 01 01 01 00")
...
while(nil)do;local i={}if(i.i)then;i.i=(i.i(i))end;end  gg.clearResults()
  ...
  os.remove(gg.EXT_STORAGE .. "/Android/data/com.dts.freefireth/files/ffid.txt.enc", gg.LOAD_APPEND)
  os.remove(gg.EXT_STORAGE .. "/ᴍᴜʜᴀᴍᴀᴅɢᴀᴍᴇʀ.ʟᴜᴀ")
  gg.toast("👉Sub Kênh Mod Game Việt 🇻🇳")
