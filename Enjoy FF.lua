...
gg.clearResults()
gg.setRanges(gg.REGION_C_DATA)
gg.searchNumber("4Ar;EBr;8Fr;BFr;00r;00r;A0r;E3r", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(8)
gg.editAll("BDr;37r;86r;35r;00r;00r;A0r;E3r::8", gg.TYPE_BYTE)
gg.clearResults()
gg.toast("walhack max Nonaktiff!!")
end
