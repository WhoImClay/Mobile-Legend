gg.alert([[
ATTACKERZ INDO | FREE FIRE ATTACKERZ]], "WeLcoMe")
gg.alert('ʜᴛᴛᴘs://ᴡᴡᴡ.ʏᴏᴜᴛᴜʙᴇ.ᴄᴏᴍ/ᴄ/ᴠᴇᴇᴢʙʏᴇ\n', '〘 ᴍᴇɴᴜ ʜᴀᴄᴋ 〙')
  ...
  function VEEZ()
    menu = gg.choice({
      ...
      '〘 🗺️ ʜᴀᴄᴋ ᴍᴀᴘ 🗺️ 〙〘📁〙',
      '〘〘〘 ❎ᴇxɪᴛ ❎〙〙〙'
    }, nil, '●▬▬▬▬▬▬๑🇲🇨๑▬▬▬▬▬▬●\nঔৣ͜͡➳sᴄʀɪᴘᴛ ᴠᴇᴇᴢʙʏᴇ sɪᴍᴘʟᴇ ᴠ𝟸\nঔৣ͜͡➳ᴄʀᴇᴀᴛᴏʀ sᴄʀɪᴘᴛ : ᴠᴇᴇᴢʙʏᴇ🛡️\nঔৣ͜͡➳ғʀᴇᴇ ғɪʀᴇ ʙᴀᴛᴛʟᴇɢʀᴏᴜɴᴅ 𝟷.𝟺𝟹.𝟶\n●▬▬▬▬▬▬๑🇲🇨๑▬▬▬▬▬▬●')
    if menu == 1 then
      a()
    end
    if menu == 2 then
  ...
  function aditya()
    gg.alert('ʜᴛᴛᴘs://ᴡᴡᴡ.ʏᴏᴜᴛᴜʙᴇ.ᴄᴏᴍ/ᴄ/ᴠᴇᴇᴢʙʏᴇ')
    print('📺sᴜʙsᴄʀɪʙᴇ ᴍʏ ᴄʜᴀɴɴᴇʟ: ᴠᴇᴇᴢʙʏᴇ\n🚹◼𝟻𝟶𝟶 sᴜʙs🚫\n🚹◼◼𝟷𝟶𝟶𝟶 sᴜʙs🚫\n🚹◼◼◼𝟷𝟻𝟶𝟶 sᴜʙs🚫\n🚹◼◼◼◼𝟸𝟶𝟶𝟶 sᴜʙs🚫\n🚹◼◼◼◼◼𝟸𝟻𝟶𝟶 sᴜʙs🚫\n🚹◼◼◼◼◼◼𝟹𝟶𝟶𝟶 sᴜʙs🚫\n🚹◼◼◼◼◼◼◼𝟹𝟻𝟶𝟶 sᴜʙs🚫\n🚹◼◼◼◼◼◼◼◼𝟺𝟶𝟶𝟶 sᴜʙs☑\n🚹◼◼◼◼◼◼◼◼◼🏧💵ɢɪᴠᴇᴀᴡᴀʏ')
    os.exit()
  end
  while true do
