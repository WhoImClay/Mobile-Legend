...
function TAMVAN()
  menu = gg.choice({
"RADAR ON [ Aktifkan Didalam GAME ]",
"RADAR OFF [ Nonaktifkan GAME Berakhir ]",
"TAB VIEW ON",
"TAB VIEW OFF",
"DRONE VIEW [ 2X ] ON",
"DRONE VIEW [ 2X ] OFF",
...
function RESKIN()
  ...
  elseif p == "71,4" then
    gg.alert("KIMMY EPIC🔸Astrocat🔸DONE ➄1�7")
  elseif p == "77,3" then
  ...
  elseif p then
    gg.alert("Code Hero " .. sh.H .. "🔢Skin Number " .. sh.S .. "◽DONE ◄1�7")
  end
end
function Exit()
  gg.skipRestoreState()
