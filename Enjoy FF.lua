...
gg.clearResults()
gg.toast("terlihat disorot 🔘")
end

function d3()
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("0000B040rA;0000803FrA;0000403FrA:9", gg.TYPE_DWORD)
gg.getResults(3)
gg.editAll("1,085,276,160;0;0", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("🅐hanya menunjukkan kritik ❗️")
end
...
gg.editAll("0", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("pemotretan yang dioptimalkan ⚡️")
end
