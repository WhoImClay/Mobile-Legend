...
'〘〘〘 ❎ᴇxɪᴛ ❎〙〙〙'},
nil,'●▬▬▬▬▬▬๑🇲🇨๑▬▬▬▬▬▬●\nঔৣ͜͡➳attackerz indo ©2020\nঔৣ͜͡➳author sᴄʀɪᴘᴛ : benny zilvers🛡️\nঔৣ͜͡➳ғʀᴇᴇ ғɪʀᴇ ʙᴀᴛᴛʟᴇɢʀᴏᴜɴᴅ ©2020\n●▬▬▬▬▬▬๑🇲🇨๑▬▬▬▬▬▬●')
if menu == 1 then news() end
...
'〘 ʙʏᴘᴀss ɴᴏ ᴇʟɪᴍɪɴᴀsɪ on🚷 〙',

'〘 ʙʏᴘᴀss ɴᴏ ᴇʟɪᴍɪɴᴀsɪ off🚷 〙',

'〘➥ Back Menu 〙'},
nil,'〘 indonesia attackerz ©bennyzilvers ©2020 〙')
if menu1 == nil then else

if menu1[1] == true then news1() end

if menu1[2] == true then news2() end

if menu1[3] == true then news3() end

if menu1[4] == true then news4() end
